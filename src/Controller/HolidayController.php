...
class HolidayController extends AbstractController{
	 ...
	 */
	public function show(int $eid=-1){
	 ...
	 */
	public function add(int $eid, Request $request){
	 ...
	 */
	public function delete(int $eid, int $id){
		$manager = $this->getDoctrine()->getManager();
	 ...
	 */
	public function validate(int $eid, int $id, Request $request){
		$manager = $this->getDoctrine()->getManager();
		$holiday = $manager->getRepository(Holiday::class)->findOneBy(["eid" => $eid, "id" => $id]);
